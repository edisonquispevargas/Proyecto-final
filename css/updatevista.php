...
$desc = $_POST['descripcion'];
    ...
    $sql = "UPDATE productos SET nombre_producto='$nombre',cantidad='$cantidad',precio_total='$precio',fecha_entrada='$fecha',
    proveedor='$proveedor',descripcion='$desc' WHERE id='$id'";
       ...
       <div class="edir">
          <div class="fila">
                <div class="row" style="text-align:center">
                    <?php if($resultado){?>
                    <h3>ACTUALIZACION CON EXITO</h3>
                    <?php } else{ ?>
                    <h3>error al modificar</h3>
                    <?php } ?>
                    
                    <a href="../mostrarPro.php" class="btn btn-success">Ver actualización</a>
                </div>
            </div>
            </div>
