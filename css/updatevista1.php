...
$stock = $_POST['stock'];
    ...
    $sql = "UPDATE precio SET nombre_producto='$nombre',precio_compra='$precioC',precio_venta='$precioV',
       ...
       <div class="edir">
          <div class="fila">
                <div class="row" style="text-align:center">
                    ...
                    <a href="../mostrarPrec.php" class="btn btn-success">Ver actualización</a>
                </div>
            </div>
            </div>
