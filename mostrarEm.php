        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de los empleados registrados en el sistema, puedes 
                     eliminar el registro completo del empleado siempre y cuando ya no trabaje mas para la empresa.
                </div>
            </div>
        </div>
       <div class="edii">
