        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/new.png" alt="calendar" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a esta sección, aquí se muestran todos los precios de productos registrados hasta la fecha. 
                    Puedes actualizar o eliminar el registro el precio del producto.
                </div>
            </div>
        </div>
       <div class="edii">
